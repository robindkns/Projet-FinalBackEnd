        ...
        <div className="Container">
          ...
          <div className="mt-14 2xl:mt-[60px]">
            <div className="grid items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-[30px]">
              {pricing ? pricing.map((pricing, index) => (
                <div
                key={index} className="border-[1px] border-lightGray dark:border-gray group hover:border-khaki dark:hover:border-khaki"
                data-aos="zoom-in-up"
                data-aos-duration="1000"
              >
                <img
                  src={`http://127.0.0.1:8000${pricing.image}`}
                  alt=""
